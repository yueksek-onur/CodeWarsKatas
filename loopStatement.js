 ...
 * }
 *
 * Wow~~,looks very cool! But if we need to calculate the
 * cumulative value from 1 to 100, the code becomes:
 *
 * function sum1_100(){
 ...
 *
 *
 * The do..while is a variant of while. The example
 ...
 * }
 *
 * while judges the condition at the beginning
 * before executing its code, so if the condition is
 * false the code inside the while loop is never executed.
 * In contrast, do..while always runs once, and then starts
 * checking the condition after that.
 *
 * Finally, it is worth mentioning: Do not forget to
 * change the value of the variable (for conditional expressions),
 ...
 * that loops n times. Each time through the loop it will add
 * one * to str, alternating on which side it is padded: the
 * first time will add a * to the left side of str, the second
 * time will add a * to the right side, and so on.
 *
 * Finally, return the padded string.
 * Series
 * ( ↑↑↑ Click the link above can get my newest kata list,
 ...
 *
 * Kata URL: https://www.codewars.com/kata/57216d4bcdd71175d6000560
 *
 *
 *
 * @param {*} str
